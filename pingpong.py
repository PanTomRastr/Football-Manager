...
# Использовал материал с сайта http://pythonicway.com/python-games/python-arcade/22-python-pong
...
BALL = c.create_oval(WIDTH / 2 - BALL_RADIUS / 2, HEIGHT / 2 - BALL_RADIUS / 2, WIDTH / 2 + BALL_RADIUS / 2,
                     HEIGHT / 2 + BALL_RADIUS / 2, fill="black")

c.create_oval(WIDTH / 2 - 3 * BALL_RADIUS, HEIGHT / 2 - 3 * BALL_RADIUS , WIDTH / 2 + 3 * BALL_RADIUS ,
                     HEIGHT / 2 + 3 * BALL_RADIUS)

LEFT_PAD = c.create_line(PAD_W / 2, 0, PAD_W / 2, PAD_H, width=PAD_W, fill="red")

RIGHT_PAD = c.create_line(WIDTH - PAD_W / 2, 0, WIDTH - PAD_W / 2, PAD_H, width=PAD_W, fill="blue")
